<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/chasing.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Chasing Mavericks</h2>
                    <p>Genre : Film biographique</p>
                    <p>Réalisateur : Michael Apted, Curtis Hanson</p>
                    <p>Durée : 116 minutes</p>
                    <p>Prix : 13€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=chasingmavericks">Ajouter au panier</a>
                </div>
            </div>
        </body>
