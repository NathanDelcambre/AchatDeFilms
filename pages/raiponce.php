<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/raiponce.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Raiponce</h2>
                    <p>Genre : Animation</p>
                    <p>Réalisateur : Bryron Howard,Nathan Greno</p>
                    <p>Durée : 100 minutes</p>
                    <p>Prix : 11€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=raiponce">Ajouter au panier</a>
                </div>
            </div>
        </body>
