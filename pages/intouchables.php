<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/intouchables.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Intouchables</h2>
                    <p>Genre : Comedie dramatique</p>
                    <p>Réalisateur : Olivier Nakache</p>
                    <p>Durée : 112 minutes</p>
                    <p>Prix : 5€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=intouchables">Ajouter au panier</a>
                </div>
            </div>
        </body>
