<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/lestuche.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Les Tuche</h2>
                    <p>Genre : Comédie</p>
                    <p>Réalisateur : Olivier Baroux</p>
                    <p>Durée : 97 minutes</p>
                    <p>Prix : 5€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=lestuche">Ajouter au panier</a>
                </div>
            </div>
        </body>
