<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/titanic.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Titanic</h2>
                    <p>Genre : Drame romantique</p>
                    <p>Réalisateur : James Cameron</p>
                    <p>Durée : 195 minutes</p>
                    <p>Prix : 7€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=titanic">Ajouter au panier</a>
                </div>
            </div>
        </body>
