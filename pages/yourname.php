<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/yourname.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Your Name</h2>
                    <p>Genre : Comédie romantique, fantastique</p>
                    <p>Réalisateur : Makoto Shinkai</p>
                    <p>Durée : 107 minutes</p>
                    <p>Prix : 6€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=yourname">Ajouter au panier</a>
                </div>
            </div>
        </body>
