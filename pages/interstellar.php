<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/interstellar.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Interstellar</h2>
                    <p>Genre : Science-fiction Drame</p>
                    <p>Réalisateur : Christopher Nolan</p>
                    <p>Durée : 169 minutes</p>
                    <p>Prix : 20€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=interstellar">Ajouter au panier</a>
                </div>
            </div>
        </body>
