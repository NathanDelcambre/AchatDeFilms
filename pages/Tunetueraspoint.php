<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/tunetueraspoint.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Tu ne tueras point</h2>
                    <p>Genre : Historique et drame</p>
                    <p>Réalisateur : Mel Gibson</p>
                    <p>Durée : 131 minutes</p>
                    <p>Prix : 8€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=Tunetueraspoint">Ajouter au panier</a>
                </div>
            </div>
        </body>
