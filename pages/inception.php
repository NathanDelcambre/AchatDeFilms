<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/inception.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Inception</h2>
                    <p>Genre : Thriller, Science-fiction</p>
                    <p>Réalisateur : Christopher Nolan</p>
                    <p>Durée : 147 minutes</p>
                    <p>Prix : 15€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=inception">Ajouter au panier</a>
                </div>
            </div>
        </body>
