<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/eiffel.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Eiffel</h2>
                    <p>Genre : Biographie historique</p>
                    <p>Réalisateur : Martin Bourboulon</p>
                    <p>Durée : 115 minutes</p>
                    <p>Prix : 16€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=eiffel">Ajouter au panier</a>
                </div>
            </div>
        </body>
