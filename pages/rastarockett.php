<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/rastarockett.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Rasta Rockett</h2>
                    <p>Genre : Comédie sportive</p>
                    <p>Réalisateur : Jon Turteltaub</p>
                    <p>Durée : 98 minutes</p>
                    <p>Prix : 9€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=rastarockett">Ajouter au panier</a>
                </div>
            </div>
        </body>
