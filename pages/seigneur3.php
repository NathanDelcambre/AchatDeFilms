<?php 
        ...
        <body>
            ...
            <div class=box>
                <div class=imageBox>
                    <img src=../imageSource/lord3.jpg>
                </div>
                <div class=contenuBox>
                    <h2>Lord of the ring 3</h2>
                    <p>Genre : Fantaisie</p>
                    <p>Réalisateur : Peter Jackson</p>
                    <p>Durée : 201 minutes</p>
                    <p>Prix : 15€</p>
                    <a class=ajouterPanier href="../traitementAjoutPanier.php?var=seigneur3">Ajouter au panier</a>
                </div>
            </div>
        </body>
